...
?>
	...
	<form name="update_thing_form" method="post" action="UpdateThing.php" enctype="multipart/form-data">
	<input name="thing_id" type="hidden" value="<?php echo $thing_id;?>" />
	<div class="container">
		<div class="col-xs-4">
		</div>
		<div class="col-xs-4">
		  <div class="form-group">
			...
			<input name="name" type="text" id="GoodName" class="form-control" value="<?php echo $thing->getThingName();?>" />
		  </div>
		</div>
	  </div><!-- /.container -->
	  <div class="container">
		...
		<div class="col-xs-4">
		  <div class="form-group">
			...
			<select name="type" id="SelectGoodType" class="form-control" />
			  <option select="selected"><?php echo $thing->getThingType();?></option>
			  <option>电子产品</option>
			  <option>书籍杂志</option>
			  <option>日用物品</option>
			  <option>文具</option>
	  ...
	  <div class="container">
		...
		<div class="col-xs-4">
		  <h3></h3>
		  <label>物品简介</label>
		  <textarea name="info" class="form-control" rows="3"><?php echo $thing->getThingInfo();?></textarea>
		</div>
	  </div><!-- /.container -->
	  <div class="container">
		<h3></h3>
		...
		<div class="col-xs-4">
		  <div class="form-group">
			...
			<p class="help-block">请上传jpg、jpeg、png格式的图片,不选择默认使用原来的图片，图片最大为2M</p>
		  </div>
		</div>
	  </div><!-- /.container -->
	  <div class="container">
