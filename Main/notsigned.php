    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="../Main/notsigned.php">首页</a></li>
              <li class="divider"></li>
              <li><a href="#">我的关注</a></li>
              <li class="divider"></li>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
           <a href="../Accounts/login.php"><button type="button" class="btn btn-success">登录</button></a>
          </li>
        </ul>
      </div>
    </nav>
      ...
      <div class="row">
        <div class="col-xs-3">
          <ul class="list-group" id="goodInfo">
            ...
            <a href="../Main/notsigned.php" class="list-group-item"><img src="../img/yixian_LOGO.png" class="img-rounded"/></a>
          </ul>
        </div>
    <?php
